...
public class ApplicationLogic{
    ...
    public ApplicationLogic() {
    	try{
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/registratec","root","rockDB64");
	 ...
	 * Edit functions
	 */
	public String editEvento(EventoDP evento){
		String query = "UPDATE evento SET nombre='"+evento.getNombre()+"',fecha_inicio_evento='"+evento.getFInE()+"',fecha_termino_evento='"+evento.getFTerE()+"',"+
		"status_evento='"+evento.getStatus()+"',capacidad_maxima='"+evento.getCMax()+"',fecha_inicio_registro='"+evento.getFInR()+"',fecha_termino_registro='"
		+evento.getFInTer()+"',id_lugar='"+evento.getIdLug()+"',no_acomp='"+evento.getAcomp()+"' WHERE id_evento='"+evento.getIdEve()+"'";
		...
		try{
			...
			System.out.println(query);
			data = "Evento actualizado en el sistema";

			statement.close();
			conexion.close();
		}catch(Exception e){
			e.printStackTrace();
			data = "Error al editar el evento";
		}finally{
	...
	public String editPonente(PonenteDP ponente){
		String query = "UPDATE ponente SET nombre='"+ponente.getNombre()+"',direccion='"+ponente.getDir()+"',"
					+"telefono='"+ponente.getTel()+"',email='"+ponente.getMail()+"' WHERE id_ponente="+ponente.getIdPon();
		String data = "";
		...
		try{
			...
			System.out.println(query);
			data = "Ponente actualizado en el sistema";

			statement.close();
			conexion.close();
		}catch(Exception e){
			e.printStackTrace();
			data = "Error al editar el ponente";
		}finally{
	...
	public String consultaEventoPorId(int idevento){
    	String datos="[";
    	String query="";
    	ResultSet tr;
	...
	public String getEventosPasados(){
		String datos = "[";
		String query = "SELECT evento.nombre, evento.fecha_inicio_evento,evento.fecha_termino_evento,lugar.nombre,evento.status_evento"+
						" FROM evento"+
						" JOIN lugar ON evento.id_lugar=lugar.id_lugar"+
						" WHERE evento.status_evento NOT IN ('ABIERTO')";
		...
		try{
			...
			while(tr.next()){
				String json = "{nombreEvento:'"+tr.getString(1) + "',fechaInicio:'"+tr.getString(2)+"',fechaTermino:'"+tr.getString(3)+
								"',nombreLugar:'"+tr.getString(4)+"',statusEvento:'"+tr.getString(5)+"'}";
				datos = datos + json + ",";
				found=true;
			}
	...
	public String getEventoTodo(){
		String datos = "[";
		String query = "SELECT evento.nombre, evento.fecha_inicio_evento,evento.fecha_termino_evento,lugar.nombre,evento.status_evento,"+
						" evento.id_evento  FROM evento"+
						" JOIN lugar ON evento.id_lugar=lugar.id_lugar"+
						"";
		...
		try{
			...
			while(tr.next()){
				String json = "{nombreEvento:'"+tr.getString(1) + "',fechaInicio:'"+tr.getString(2)+"',fechaTermino:'"+tr.getString(3)+
				"',nombreLugar:'"+tr.getString(4)+"',statusEvento:'"+tr.getString(5)+"',idEvento:'"+tr.getString(6)+"'}";
				datos = datos + json + ",";
				found=true;
			}
	 ...
	 * Delete functions
	 */
	public String borrarEvento(int eventoId){
    	String query="";
    	String datos="";
    	String works="";
    	query="DELETE FROM evento WHERE id_evento="+eventoId;
    	System.out.println(query);
    	...
    	try{
    		...
    		works="FUNCIONA"+query;
			datos="El evento ha sido borrado";
			
			statement.close();
			conexion.close();
    	}catch(Exception sqle){
    		System.out.println("Error: "+sqle);
    		datos="Error en el borrado del evento";
    	}finally{
	...
	public String borrarPonente(int ponenteId){
    	String query="";
    	String datos="";
    	String works="";
    	query="DELETE FROM ponente WHERE id_ponente="+ponenteId;
    	System.out.println(query);
    	...
    	try{
    		...
    		works="FUNCIONA"+query;
			datos="El ponente ha sido borrado";
	...
	public String obtenerPonente(int id){
		String query = "SELECT * FROM PONENTE WHERE id_ponente="+id;
		String datos = "[";
		ResultSet rs;
		int found = 0;
