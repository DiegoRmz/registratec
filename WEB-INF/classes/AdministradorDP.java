...
public class AdministradorDP {
    ...
    public String toStringSQL(){
        ...
        return "('"+this.id_administrador+"','"+this.id_departamento+"','"+this.nombre+"','"+this.contrasena+"','"+this.direccion+"','"+this.telefono+"','"+this.email+"',STR_TO_DATE('"+this.fecha_nacimiento+"','%Y-%m-%d'),'"+this.posicion+"','True')";
    }
