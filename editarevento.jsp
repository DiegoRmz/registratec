    ...
    <body onload="menuLugares()">
        ...
        <aside class="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigations">
                        ...
                        <li id="" class="bold"><a class="collapsible-header"><i class=""></i>Eventos</a>
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li class="bold"><a href="editaryborrareventos.jsp">Editar y borrar eventos</a></li>
                                    <li class="bold"><a href="subircarta.jsp">Subir carta</a></li>
                                    <li class="bold"><a href="cartaparaevento.jsp">Añadir carta</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                        ...
                        <li id="" class="bold"><a class="collapsible-header"><i class=""></i>Ponentes</a>
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li class="bold"><a href="editaryborrarponentes.jsp">Editar y borrar ponentes</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li id="" class="bold"><a class="collapsible-header"><i class=""></i>Otros</a>
                            <div class="collapsible-body">
                                <ul>
        ...
        <div class="container">
            <div class="container">
                ...
                <form id="eventForm">
                    ...
                    <input type="text" maxlenght="15" name="nombre" id="nombre" required>
                    <br>
                    <label>Fecha de inicio del evento</label>
                    <input type="date" name="FInE"  id="FInE" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                    <label>Fecha de término del evento</label>
                    <input type="date" name="FTerE" id="FTerE" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                    ...
                    <input type="number" min="3" max="100" name="cMax" id="cMax" required>
                    <label>Fecha de inicio de registro</label>
                    <input type="date" name="FInR" id="FInR" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                    <label>Fecha de termino de registro</label>
                    <input type="date" name="FInTer" id="FInTer" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                    ...
                    <input type="number" name="acomp" id="acomp" required min="0" max="10" value="0">
                    <input type="button" name="action" value="Editar evento" class="btn waves-effect waves-light"  onclick="editarEvento();" id="ev">
                </form>
                <br>
                <br>
            </div>
